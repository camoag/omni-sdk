...
class OmniDashboardEmbedder:
    ...
    def __init__(
        ...
        assert omni_config.embed_secret  # Required to appease mypy. If embed_secret is missing an OmniConfigError will have already been raised by the OmniConfig class.
