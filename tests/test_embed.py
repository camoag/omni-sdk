...
from omni import DashboardEmbedUrlFactory


@pytest.fixture
def embedder():
    return DashboardEmbedUrlFactory(organization_name='acme', embed_secret='super_secret')
...
class TestEmbed:
    def test_kitchen_sink(self, embedder):
        url = embedder.build_url(
            ...
            external_id='1',
            name='Somebody',
            custom_theme={"dashboard-background": "#00FF00", "dashboard-tile-background": "#00FF00"},
            entity="Acme",
